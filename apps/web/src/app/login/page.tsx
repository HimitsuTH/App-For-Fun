...
/* ─── tiny keyframe injector (no new package) ─── */
const STYLES = `
    ...
    <>
      ...
      <div style={{
        ...
        <div className="login-wrap" style={{
          ...
          borderRadius: '24px',
          overflow: 'hidden',
          boxShadow: '0 32px 80px rgba(99,102,241,0.18), 0 8px 24px rgba(0,0,0,0.08)',
          ...
          <div className="login-left" style={{
            ...
            <div style={{ position: 'relative' }}>
              ...
              <h2 style={{
                ...
                lineHeight: 1.25, letterSpacing: '-0.03em', margin: 0,
              }}>
                จัดการการเงิน<br/>
                <span style={{
            ...
            <div style={{ display:'flex', gap:'6px', justifyContent:'center', opacity:0.4 }}>
              {[1,2,3].map(i => (
                <div key={i} style={{
                  width: i===1?'20px':'6px', height:'6px', borderRadius:'3px',
                  background:'#fff',
            ...
            <form onSubmit={handleSubmit(onSubmit)} style={{ display:'flex', flexDirection:'column', gap:'1.1rem' }}>
              ...
              <div>
                <label style={{
                  ...
                  color: focusedField==='username' ? '#6366f1' : '#475569',
                ...
                {errors.username && (
                  <p style={{ color:'#ef4444', fontSize:'0.73rem', marginTop:'0.3rem', display:'flex', alignItems:'center', gap:'0.25rem' }}>
              ...
              <div>
                <label style={{
                  display:'block', fontSize:'0.78rem', fontWeight:600,
                  color: focusedField==='password' ? '#6366f1' : '#475569',
                  marginBottom:'0.4rem', transition:'color 0.2s',
                  letterSpacing:'0.02em',
                }}>รหัสผ่าน</label>
                <div style={{ position:'relative' }}>
